...
const GOOGLE_FORM_URL =
  "https://docs.google.com/forms/d/e/1FAIpQLSeZWdOgo-UbXJkqudpEBfviM6N98S7AGXhiyGXDcmielUvIKQ/viewform";
    ...
    <div className="min-h-screen bg-black font-body text-white selection:bg-primary/30 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 text-center">
        ...
        <div className="relative z-10 px-4">
          <h1 className="font-display text-5xl md:text-7xl font-black mb-6 uppercase tracking-tighter italic overflow-visible">
            CHOOSE YOUR{" "}
            <span className="inline-block pr-12 text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-pink-600">
              ARENA
            </span>
          </h1>
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
            Explore the competitions. Click on any game to register directly via
            our official form.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {categories.map((cat, index) => (
            ...
            >
              <div
                className={`h-32 w-full bg-linear-to-b ${cat.color} flex items-center justify-center relative overflow-hidden`}
              >
              ...
              <div className="p-6">
                ...
                <div className="mt-8 pt-6 border-t border-white/10 text-center">
                  <Button
                    className={`w-full font-bold uppercase tracking-wider bg-gradient-to-r ${cat.color} text-white border-none shadow-lg hover:brightness-110`}
                    asChild
                  >
                    <a
                      href={GOOGLE_FORM_URL}
